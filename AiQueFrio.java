...
public class AiQueFrio {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter file1 = new FileWriter("Terceiro_Infectados.txt");
        FileWriter file2 = new FileWriter("Terceiro_Suscetiveis.txt");
        FileWriter file3 = new FileWriter("Terceiro_Removidos.txt");
        ...
        while (!infectados.isEmpty()){
            ...
            Busca(grafo, infectados.getFirst(), infectados);
